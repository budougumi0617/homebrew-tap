...
class Dkl < Formula
  ...
  if OS.mac?
    url "http://github.com/budougumi0617/dkl/releases/download/v0.0.0/dkl_0.0.0_Darwin_x86_64.tar.gz"
    sha256 "d567ace51cee949e87ed7be41c0126fe407c5b7f3c5e91e3288981840a3e889d"
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "http://github.com/budougumi0617/dkl/releases/download/v0.0.0/dkl_0.0.0_Linux_x86_64.tar.gz"
